...
1. [Knowledge Graphs Meet Multi-Modal Learning: A Comprehensive Survey. Submitted to Proc. IEEE](https://arxiv.org/abs/2402.05391)
...
1. [Distributed Representations of Entities in Open-World Knowledge Graphs. Knowledge-Based Systems, 2024](https://www.sciencedirect.com/science/article/abs/pii/S095070512400217X)

    <small>Lingbing Guo, Zhuo Chen, Jiaoyan Chen, Yichi Zhang, Zequn Sun, Zhongpo Bo, Yin Fang, **Xiaoze Liu**, Huajun Chen, Wen Zhang</small>

1. [MultiEM: Effective and Efficient Unsupervised Multi-Table Entity Matching. ICDE 2024](https://arxiv.org/abs/2308.01927)
...
1. [Universal Multi-modal Entity Alignment via Iteratively Fusing Modality Similarity Paths. arXiv](https://browse.arxiv.org/abs/2310.05364)
