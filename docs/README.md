...
- **2025:** KDD (Research Track), ICLR, ICML, NeurIPS, ACL Rolling Review (ACL, EMNLP, NAACL)
- **2024:** KDD (Research Track), NeurIPS (Research & Dataset Track), ACM MM, SDM, CIKM, ISWC (Poster  & Demo Track), ACL Rolling Review (ACL, EMNLP, NAACL)
