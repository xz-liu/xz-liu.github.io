...
- **[Jan 2025]** [LLM Causal Reasoning Survey](https://arxiv.org/abs/2410.16676) accepted by [NAACL 2025](https://2025.naacl.org/).
...
1. [Survey on Factuality in Large Language Models: Knowledge, Retrieval and Domain-Specificity.](https://arxiv.org/abs/2310.07521)
    ...
    **ACM Computing Surveys (Accepted)**, 2025
    </small>
...
1. [Improving Causal Reasoning in Large Language Models: A Survey.](https://arxiv.org/abs/2410.16676)
...
- **2025:** KDD (Research Track), ICLR, ICML
