...
- **[May 2025]** I will join [Amazon AWS AI](https://aws.amazon.com/) as an Applied Scientist Intern in Summer 2025.
...
- **[Mar 2025]** We release [SUV](https://arxiv.org/abs/2503.22948), a scalable copyright compliance framework for large language models (LLMs) with regularized selective unlearning.
...
- **PhD Student**, [Purdue University](https://purdue.edu/), 2023 - Present
    ...
    - **Applied Scientist Intern**, [Amazon AWS AI](https://aws.amazon.com/), 2025
