...
- **[Jan 2026]**  We release [tokenforge](./tokenforge), exposing [tokenizer transplant](https://github.com/arcee-ai/mergekit/tree/main?tab=readme-ov-file#tokenizer-transplantation-mergekit-tokensurgeon) as a critical supply-chain attack surface in modular AI. We demonstrate how the [standard merging pipeline](https://github.com/arcee-ai/mergekit/) can be exploited to inject "sleeper" backdoors that remain mathematically inert in donor models but activate downstream.
 <!-- We release [tokenforge](./tokenforge), a novel attack against [ in [ LLM merging](https://github.com/arcee-ai/mergekit/) pipelines!  -->
...
1. [The The Trojan in the Vocabulary: Stealthy Sabotage of LLM Composition](https://xz-liu.github.io/tokenforge/)
